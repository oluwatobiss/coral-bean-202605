...
export default function App() {
  ...
  return (
    <div className={`h-screen flex overflow-hidden font-sans transition-colors duration-300 ${
      ...
      {/* Unified themed sidebar */}
      <Sidebar activePage={activePage} setActivePage={setActivePage} isDark={isDark} />

      {/* Content wrapper */}
      <div className="flex-1 flex flex-col min-w-0 pl-64">
        
        {/* Unified themed header with theme switcher */}
        <Header activePage={activePage} setActivePage={setActivePage} isDark={isDark} setIsDark={setIsDark} />

        {/* Dynamic page view mount canvas */}
